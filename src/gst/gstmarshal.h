...
extern
void _gmarshal_VOID__OBJECT_ENUM (GClosure     *closure,
                                  GValue       *return_value,
...
extern
void _gmarshal_VOID__OBJECT_INT64 (GClosure     *closure,
                                   GValue       *return_value,
                                   guint         n_param_values,
                                   const GValue *param_values,
                                   gpointer      invocation_hint,
...
extern
void _gmarshal_VOID__OBJECT_INT (GClosure     *closure,
                                 GValue       *return_value,
                                 guint         n_param_values,
                                 const GValue *param_values,
                                 gpointer      invocation_hint,
...
extern
void _gmarshal_VOID__OBJECT_DOUBLE (GClosure     *closure,
                                    GValue       *return_value,
                                    guint         n_param_values,
                                    const GValue *param_values,
                                    gpointer      invocation_hint,
